  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta charSet="utf-8" />
        <meta name="author" content="Saihaj Law" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta property="og:title" content="Saihaj Law" />
        <meta
          property="og:description"
          content="I am a student developer with an interest in low-level programming, quantum computing, and AI"
        />
